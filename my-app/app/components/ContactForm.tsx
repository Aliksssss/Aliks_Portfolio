...
/**
 * ContactForm is a React component that renders a contact form allowing users to send a message.
 * It includes input fields for name, email, and message, and uses EmailJS to send form data.
 * The component provides feedback on submission status with success and error messages.
 * It also shows a temporary welcome modal when a name is entered.
 */
const ContactForm = () => {
    ...
    <div className="relative">
      <AnimatePresence>
        {showNameModal && (
          ...
          >
            <div className="bg-black/90 backdrop-blur-sm border border-[#83792E]/30 px-4 py-2 rounded-xl shadow-xl w-full text-center">
              <p className="text-transparent bg-clip-text bg-gradient-to-r from-[#83792E] to-[#83792E]/70 font-semibold text-base whitespace-normal">
      ...
      <div className="w-full">
        <h1 className="mb-2 text-xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-[#83792E]/80 to-[#83792E]">
          Contact ✌️
        </h1>
        ...
        <form ref={form} onSubmit={handleSubmit} className="space-y-4">
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#83792E]/60 to-[#83792E] rounded-lg blur opacity-10 
            ...
            <div className="relative">
              <input
                ...
                className="relative w-full px-4 py-3 bg-black/40 backdrop-blur-sm rounded-lg border border-white/10 
                         text-sm text-white placeholder-gray-400 focus:outline-none focus:border-[#83792E]/40 transition-colors"
                required
              />
              <AnimatePresence>
                {nameEntered && (
                  ...
                  >
                    <div className="bg-[#83792E]/20 backdrop-blur-sm rounded-full px-2 py-1">
          ...
          <button
            ...
            className={`w-full px-4 py-2 text-sm text-white bg-gradient-to-r from-[#83792E]/80 to-[#83792E] rounded-lg 
                      hover:from-[#83792E]/90 hover:to-[#83792E] focus:outline-none focus:ring-2 focus:ring-[#83792E]/50 
